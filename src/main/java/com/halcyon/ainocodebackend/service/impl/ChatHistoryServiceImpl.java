...
import com.halcyon.ainocodebackend.model.enums.ChatHistoryMessageTypeEnum;
import com.halcyon.ainocodebackend.service.AppService;
import com.halcyon.ainocodebackend.service.ChatHistoryService;
import com.halcyon.ainocodebackend.mapper.ChatHistoryMapper;
...
//                    .limit(1, maxCount);
    ...
    public QueryWrapper<ChatHistory> getQueryWrapper(ChatHistoryQueryRequest chatHistoryQueryRequest) {
        ...
        queryWrapper.eq(Objects.nonNull(appId), "appId", appId);
